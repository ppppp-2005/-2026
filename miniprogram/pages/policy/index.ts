import { policyMock } from "../../data/policy";

function getPoliciesByCategory(categoryId: string) {
  if (categoryId === "all") {
...
Page({
  ...
  onPolicyDetailTap(event: WechatMiniprogram.TouchEvent) {
  ...
  onConsultTap(event: WechatMiniprogram.TouchEvent) {
