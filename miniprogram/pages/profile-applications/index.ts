...
function filtersWithCounts(records: typeof profileMock.applications.records) {
...
Page({
  ...
  onFilterTap(event: { currentTarget: { dataset: { status: string } } }) {
  ...
  onRecordTap(event: { currentTarget: { dataset: { id: string } } }) {
