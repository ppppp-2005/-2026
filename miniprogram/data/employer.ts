...
export function cloneLocal(value) {
  return JSON.parse(JSON.stringify(value));
}

export function calculateProfileProgress(company) {
...
export function validateJobDraft(draft) {
  const errors = {};
...
export function buildJobPreview(draft) {
...
export function normalizeJobPreview(value) {
...
export function filterCandidates(candidates, statusId, query, jobId) {
